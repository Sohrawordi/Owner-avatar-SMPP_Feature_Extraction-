...
plt.plot(fpr_SMPP,tpr_SMPP,label="SMPP, AUC="+str(99.43))
...
tpr_PLP_FS= np.loadtxt("tpr_raf_independent.txt",delimiter=",")
fpr_PLP_FS= np.loadtxt("fpr_raf_independent.txt",delimiter=",")
plt.plot(fpr_PLP_FS,tpr_PLP_FS,label="raf, AUC="+str(94.38))

tpr_PLP_FS= np.loadtxt("tpr_BERT_independent.txt",delimiter=",")
fpr_PLP_FS= np.loadtxt("fpr_BERT_independent.txt",delimiter=",")
...
plt.plot(fpr_PLP_FS,tpr_PLP_FS,label="AAC+BE+CKSAAP, AUC="+str(95.45))


tpr_predPhogly_Site= np.loadtxt("tpr_predPhogly-Site_test.txt",delimiter=",")
fpr_predPhogly_Site= np.loadtxt("fpr_predPhogly-Site_test.txt",delimiter=",")
plt.plot(fpr_predPhogly_Site,tpr_predPhogly_Site,label="Sequence_coupling, AUC="+str(93.21))
